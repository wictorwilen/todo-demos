...
export interface ITodoTeamsConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ITodoTeamsConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the todoTeamsConnector Connector connect page
 */
export class TodoTeamsConnectorConfig extends TeamsBaseComponent<ITodoTeamsConnectorConfigProps, ITodoTeamsConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                const settings: microsoftTeams.settings.Settings = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/todoTeamsConnector/config.html`,
